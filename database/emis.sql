...
INSERT INTO `user_accounts` (`fullname`, `email`, `password`, `user_type`, `contact_no`, `address`, `birthday`, `gender`, `age`, `status`)
VALUES ('Admin Name', 'admin@example.com', 'admin1234', 'admin', '0123456789', 'Admin Address', '1980-01-01', 'Female', '40', 'Active');
