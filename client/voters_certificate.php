...
<head>
    ...
    <title>calintaan comunity chapter | Calintaan Occidental mindoro Municipal Grand Council</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 bg-success position-relative">
        <div class="col-4 d-flex align-items-center justify-content-start gap-3 text-white" style="height: 75px;">
    ...
    <div style="
      ...
      " class="container-fluid p-4 text-center">
        <button class="btn btn-lg px-5 py-3 border-0 fw-bold rounded-0 col-4"
            style="background-image: linear-gradient(white, rgb(216, 210, 30));">Calintaan Community Chapter</button><br><br>
        ...
        <div class="row text-start mt-4 gap-3 justify-content-center">
            ...
            <div class="col col-md-4 border border-success p-4 rounded position-relative">
                <h4>Prepare your Requirements: </h4>
                <p class="">
                    <i class="fa fa-check"></i> Birth Certificate <br>
                    <i class="fa fa-check"></i> Valid I.d or Student I,d
                </p>
