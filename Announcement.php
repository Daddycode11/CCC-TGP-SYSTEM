...
<html lang="en">
  <head>
    ...
    <title>Announcement | Calintaan OCC. MDO. Municipal Grand Council</title>
  ...
  <body>
    ...
    >
      ...
      >
        ...
        />
        <h1 class="fw-bold fs-1 mt-1" style="margin-left: 7rem">
          Calintaan OCC. MDO. Municipal Grand Council
        </h1>
      </div>
    ...
    <div class="container-fluid">
      <div class="container p-5">
        <button class="btn btn-success rounded-0 px-5">Announcement</button>
